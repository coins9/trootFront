...
const TattooSupplyDetailScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {/* ── Carousel (native-like snap via FlatList) ── */}
          ...
          <View style={[styles.topBar, { paddingTop: insets.top + 8 }]}>
            ...
            <View style={styles.topRight}>
              ...
              >
                <HeartIcon
                  size={22}
                  color={bookmarked ? COLORS.gold : COLORS.black}
                  filled={bookmarked}
                />
              </TouchableOpacity>
              <TouchableOpacity
        ...
        <View style={styles.infoBlock}>
          {supply.brand && <Text style={styles.brand}>{supply.brand}</Text>}
            ...
            <View style={styles.optionChipRow}>
              {group.values.map((v) => {
                ...
                return (
                  <TouchableOpacity
                    key={v}
                    onPress={() => handleOptionSelect(group.label, v)}
                    activeOpacity={0.8}
